namespace LTestApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnCliProvService = new System.Windows.Forms.Button();
			this.SuspendLayout();
			// 
			// button1
			// 
			...
			// btnCliProvService
			// 
			this.btnCliProvService.Location = new System.Drawing.Point(199, 121);
			this.btnCliProvService.Name = "btnCliProvService";
			this.btnCliProvService.Size = new System.Drawing.Size(140, 23);
			this.btnCliProvService.TabIndex = 8;
			this.btnCliProvService.Text = "Client Prov Service";
			this.btnCliProvService.UseVisualStyleBackColor = true;
			this.btnCliProvService.Click += new System.EventHandler(this.btnCliProvService_Click);
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.btnCliProvService);
		...
		private System.Windows.Forms.Button btnCliProvService;
    }
}
